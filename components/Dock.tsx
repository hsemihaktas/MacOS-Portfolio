        ...
        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 p-2 z-[9999]">
            <div className="flex items-end gap-3 bg-white/10 backdrop-blur-3xl border border-white/20 rounded-[22px] px-3 py-2 shadow-[0_30px_60px_rgba(0,0,0,0.4)] ring-1 ring-black/5">
                ...
                {APPS.map((app) => {
                    ...
                    return (
                        <div key={app.id} className="relative group cursor-default flex flex-col items-center" onClick={() => onAppClick(app.id)}>
                ...
                <div className="flex items-center gap-2">
                    <a href="https://github.com/hsemihaktas" target="_blank" className="group relative w-[48px] h-[48px] bg-black/10 hover:bg-black/20 backdrop-blur-xl rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-[1.2] hover:-translate-y-4 origin-bottom">
                        <Github size={24} className="text-white/80" />
                    </a>
                    <a href="https://linkedin.com/in/hsemihaktas" target="_blank" className="group relative w-[48px] h-[48px] bg-[#0077b5]/20 hover:bg-[#0077b5]/30 backdrop-blur-xl rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-[1.2] hover:-translate-y-4 origin-bottom border border-[#0077b5]/10">
                        <Linkedin size={24} className="text-white/80 fill-white/20" />
                    </a>
                    <a href="https://twitter.com/hsemihaktas" target="_blank" className="group relative w-[48px] h-[48px] bg-black/10 hover:bg-black/30 backdrop-blur-xl rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-[1.2] hover:-translate-y-4 origin-bottom border border-black/10">
                        <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white/80" fill="currentColor">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                        </svg>
                    </a>
                </div>
